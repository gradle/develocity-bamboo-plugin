...
class UtilsTest {
    ...
    private final BuildContext buildContext = Mockito.mock(BuildContext.class);
    ...
    void vcsRepoUrlsNoRepos() {
        ...
        Set<String> repoUrls = Utils.vcsRepoUrls(buildContext);

        MatcherAssert.assertThat(repoUrls, Matchers.emptyIterable());
    }
    ...
    void vcsRepoUrls() {
        ...
        MatcherAssert.assertThat(repoUrls, Matchers.equalTo(Sets.newHashSet("http://foo.git", "https://github.com/bar")));
    }
