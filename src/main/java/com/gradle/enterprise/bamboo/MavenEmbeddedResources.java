...
public final class MavenEmbeddedResources {
    ...
    private static final File DEFAULT_TARGET_DIRECTORY = new File(".gradle-enterprise-plugin/maven");
    ...
    enum Resource {
        ...
        GE_EXTENSION(
            "gradle-enterprise-maven-extension-" + Versions.GE_EXTENSION_VERSION + ".jar",
        ...
        String getName() {
            return String.format("/gradle-enterprise/maven/%s", sourceFilename);
        }
